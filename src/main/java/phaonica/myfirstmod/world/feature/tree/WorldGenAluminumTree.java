package phaonica.myfirstmod.world.feature.tree;
...
{
	public static final IBlockState LOG = BlockInit.log.getDefaultState().withProperty(CustomBlockLog.VARIANT, CustomBlockPlanks.EnumType.ALUMINIUM);
	public static final IBlockState LEAF = BlockInit.leaves.getDefaultState().withProperty(CustomBlockLeaves.VARIANT, CustomBlockPlanks.EnumType.ALUMINIUM);
	...
	public boolean generate(World world, Random rand, BlockPos pos)
	{
		...
		else
		{
			...
			boolean isSoil = stateOfBlockBelowSapling.getBlock().canSustainPlant(stateOfBlockBelowSapling, world, blockBelowSapling, EnumFacing.UP, (CustomBlockSapling)BlockInit.sapling);
